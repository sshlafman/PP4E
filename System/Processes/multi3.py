...
from test.test_richcmp import VectorTest
...
def updater(val, arr):
    ...
    val.value += 1     # passed in objects ARE shared
...
if __name__ == '__main__':
    ...
    # all see the last interation's result because all share objects
    ...
    for i in range(procs):
        ...
        ps.append(p)
    for p in ps: p.join()
    # show final results here                    # scalar=12:    +6 parent in 6 children
